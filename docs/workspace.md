...
- `/api/`: Laravel API. Owns authentication, validation, orchestration, implemented post/interaction endpoints, persistence, and API responses. Future feed ranking and search remain deferred.
